...
let pizza = { name: 'Supreme', price: 13.99, category: 'classic', popularity: 5, rating: 92, tags: ['old fashioned', 'has meat', 'customer favorite'] };
...
const foodArr = [
    ...
    { name: 'BBQ Wings', price: 7.99, category: 'salad', popularity: 3, rating: 81, tags: ['salad', 'health', 'vegetarian'] }, ,
